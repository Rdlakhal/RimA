...
`;
    ...
    const numberOfCommands = 42; // Replace with the actual number of commands

    console.log(chalk.bold.hex("#FF0000").bold("  ▂▃▄▅▆▇█▓▒░𝗟𝗢𝗔𝗗𝗜𝗡𝗚░▒▓█▇▆▅▄▃▂"));
    console.log(chalk.blue.bold(logo));
    console.log(chalk.blue.bold(`Number of commands: ${numberOfCommands}`));
})();
